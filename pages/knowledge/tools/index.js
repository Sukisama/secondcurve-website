      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">工具库</h1>
          </div>
          {user && (
            <Link
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {tools.map((tool) => (
              <Link key={tool.id} href={`/knowledge/tools/${tool.id}`}>
                <div className="border border-gray-200 rounded-xl p-4 sm:p-5 hover:border-gray-300 hover:shadow-sm transition h-full">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-gray-900">{tool.title}</h3>
