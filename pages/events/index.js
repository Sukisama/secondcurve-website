            ...
            return (
              ...
              >
                <div className="p-4 sm:p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 sm:space-x-3 mb-2">
                        <span className={`px-2 py-1 sm:px-3 rounded-full text-xs sm:text-sm font-medium ${status.class}`}>
                          {status.text}
                        </span>
                        {isVIP && event.status === 'upcoming' && (
                          <span className="px-2 py-1 sm:px-3 rounded-full text-xs sm:text-sm font-medium bg-yellow-100 text-yellow-800">
                            VIP免费
                          </span>
                        )}
                      </div>
                      <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">{event.title}</h2>
                    ...
                    {event.image_url && (
                      <img
                        src={event.image_url}
                        alt={event.title}
                        className="hidden sm:block w-32 h-32 object-cover rounded-xl ml-4"
                      />
                    )}
                  </div>

                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 py-3 sm:py-4 border-t border-gray-100">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-3 sm:pt-4 gap-3">
                    ...
                    {event.status === 'upcoming' && (
                      event.mini_program_link ? (
                        <a
                          ...
                          className="w-full sm:w-auto bg-gray-900 text-white px-6 py-2.5 sm:py-2 rounded-xl font-medium hover:bg-gray-800 transition text-center"
                        >
                          前往小程序报名
                        </a>
                      ) : (
                        <button
                          ...
                          className="w-full sm:w-auto bg-gray-900 text-white px-6 py-2.5 sm:py-2 rounded-xl font-medium hover:bg-gray-800 transition"
                        >
                          立即报名
                        </button>
                      )
