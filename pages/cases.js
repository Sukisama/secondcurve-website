      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {canPublish && (
              <button
                ...
                className="bg-gray-900 text-white px-5 py-2.5 rounded-xl font-medium hover:bg-gray-800 transition whitespace-nowrap"
              >
                发布案例
              </button>
            )}
                ...
                <div key={item.id} className="group relative">
                  ...
                  {canDelete && (
                    <button
                      ...
                      className="absolute top-4 right-4 bg-white bg-opacity-90 hover:bg-red-50 text-gray-400 hover:text-red-600 p-2 rounded-lg transition opacity-0 group-hover:opacity-100"
                      title="删除案例"
                    >
        ...
        {!loading && filteredCases.length === 0 && (
          <div className="text-center py-16 text-gray-400">
            ...
            <p className="text-lg mb-2">暂无「{activeCategory}」类目的案例</p>
            {canPublish && (
              <button
                onClick={() => setShowPublishModal(true)}
                className="mt-4 bg-gray-900 text-white px-6 py-2.5 rounded-xl font-medium hover:bg-gray-800 transition"
              >
                发布第一个案例
              </button>
            )}
