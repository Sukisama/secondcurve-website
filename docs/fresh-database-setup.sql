...
('create_post', '发布帖子', 10, '发布帖子获得积分'),
('create_case', '发布实战案例', 50, '发布实战案例获得积分'),
('join_event', '参加活动', 20, '参加活动获得积分'),
('elite_post', '帖子被设为精华', 100, '帖子被设为精华获得积分'),
('comment_post', '评论帖子', 5, '评论帖子获得积分')
